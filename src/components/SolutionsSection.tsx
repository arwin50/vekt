  ...
  const solutions = [
    {
      ...
      description: "accurate, consistent, and ready data for meaningful analysis and decision-making.",
    ...
    },
    {
      ...
      description: "anticipate future trends, outcomes, and behaviors, empowering your business with data-driven foresight.",
      image: predictiveModelingImage,
    },
    {
      icon: BarChart3,
      title: "Dashboarding and Visualization",
      description: "transform your complex data into clear, interactive visuals and dashboards.",
      image: dashboardVizImage,
    },
    {
      icon: Lightbulb,
      title: "Analysis and Insights",
      description: "turn your data into clear, meaningful information that guides smarter decisions.",
      image: insightsAnalystImage,
    },
  ];

  return (
    <section id="services" className="w-full py-20 px-8 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {solutions.map((solution, index) => {
            ...
            return (
              <div 
                key={index}
                className={`bg-vekt-light rounded-lg p-6 hover:shadow-lg transition-shadow ${
                  isLastItem ? 'md:col-span-2 lg:col-span-1' : ''
                }`}
              >
                <div className="mb-4">
                  <IconComponent className="w-8 h-8 text-vekt-dark" />
                </div>
                
                <h3 className="text-xl font-bold text-vekt-dark mb-3">
                  {solution.title}
                </h3>
                
                <p className="text-vekt-dark mb-4 leading-relaxed">
